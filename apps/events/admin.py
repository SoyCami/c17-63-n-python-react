...
class EventAdmin(admin.ModelAdmin):
    list_display = ("event_name", "event_organizer", "event_date",)
    search_fields = ("event_name", "event_category__name", "event_organizer__username",)
...
class EventRegisteredUserAdmin(admin.ModelAdmin):
    list_display = ("event", "user", "registration_status",)
