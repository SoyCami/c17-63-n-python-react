                    ...
                    <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                        ...
                        <div className="relative ml-4 flex-shrink-0">
                            ...
                            <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button">
                                <a href="#" className="block px-4 py-2 text-sm text-yellow-600" role="menuitem"  id="user-menu-item-0">Your Profile</a>
                                <a href="#" className="block px-4 py-2 text-sm text-yellow-600" role="menuitem" id="user-menu-item-1">Settings</a>
                                <a href="#" className="block px-4 py-2 text-sm text-yellow-600" role="menuitem"  id="user-menu-item-2">Sign out</a>
                            </div>
                        </div>
                    </div>
                </div>
