...
export default function SignUpPassword(): ReactElement {
  ...
  return (
    ...
    <p className="text-sm text-gray-500 mb-2">La contraseña debe tener al menos: 8 caracteres, una letra mayúscula, una letra minúscula, un número y un carácter especial.</p>
    <input
      type="password"
      id="password"
      value={password}
