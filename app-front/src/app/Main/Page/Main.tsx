            ...
            <header className="min-h-screen bg-white ">
                <div className="md:flex space-x-16  ">
                    <div className="md:flex items-center pl-16 ">
                            <h1 className="py-8 px-3 lg:text-3xl font-bold text-[#143C3A] ">Nuestros eventos</h1>
                    </div>
                </div>

                <div id="services" className="section relative pt-5 md:pt-5 bg-white">
                        ...
                        <div className="flex flex-wrap flex-row -mx-4 text-center">
                            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                                ...
                                <div className="py-8 px-12 mb-12">
                                    <div className="inline-block text-[#143C3A] bg-[#D9D9D9] rounded-full py-12 px-12 ransition duration-300 hover:-translate-y-2">
                                    ...
                                    <h3 className="text-lg text-[#143C3A] leading-normal mb-2 font-semibold">Taller VueJS</h3>
                                </div>
                            ...
                            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >
                                ...
                                <div className="py-8 px-12 mb-12">
                                    ...
                                    <h3 className="text-lg text-[#143C3A] leading-normal mb-2 font-semibold">Taller CSS &amp; SASS</h3>
                                </div>
